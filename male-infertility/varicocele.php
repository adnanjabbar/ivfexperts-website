<?php
$pageTitle = ucfirst(str_replace("-", " ", "varicocele")) . " | IVF Experts";
$metaDescription = "Detailed information about varicocele and its treatment options.";
include("../includes/header.php");
?>

<section class="hero-gradient text-white text-center py-24">
<h1 class="text-4xl font-bold mb-4">Varicocele</h1>
<p class="max-w-3xl mx-auto">Comprehensive diagnosis and advanced treatment solutions for varicocele.</p>
</section>
